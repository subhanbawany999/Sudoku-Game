...
public class SudokuGenerator {
    ...
    public static int[][] generate(int difficulty) {
        Random r = new Random();
        int maxCount; //This keeps the count of empty spaces
        if (difficulty == 0) {
            maxCount = 38; //Easy can have at most 38 empty spaces
        } else if (difficulty == 1) {
            maxCount = 45; //Medium can have at most 45 empty spaces
        } else if (difficulty == 2) {
            maxCount = 49; // Hard can have at most 49 empty spaces
        } else {
            maxCount = 35;//for modern game mode
        }
